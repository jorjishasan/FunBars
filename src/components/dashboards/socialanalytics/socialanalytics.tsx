...
import LanguageDropdown from '@/components/dashboards/socialanalytics/dropdown-language'
import ProductInsightsCard from '@/components/dashboards/socialanalytics/widget-product-insights'
import ProfileDropdown from '@/components/dashboards/socialanalytics/dropdown-profile'
import SalesMetricsCard from '@/components/dashboards/socialanalytics/chart-sales-metrics'
import StatisticsCard from '@/components/dashboards/socialanalytics/statistics-card-01'
import TotalEarningCard from '@/components/dashboards/socialanalytics/widget-total-earning'
import TransactionDatatable, { type Item } from '@/components/dashboards/socialanalytics/datatable-transaction'
        ...
        <div className='flex flex-1 flex-col'>
              ...
              <div className='flex items-center gap-4'>
                ...
                <Breadcrumb className='hidden sm:block'>
                  <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbPage>Social Analytics</BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
              </div>
                  ...
                  trigger={
                    <Button variant='ghost' className='h-8 w-8 p-0'>
                      <Avatar className='h-9 w-9 rounded-md'>
                        ...
                        />
                        <AvatarFallback className='h-full w-full'>JD</AvatarFallback>
                      </Avatar>
                    </Button>
                  }
                />
          ...
          <main className='mx-auto size-full max-w-7xl flex-1 px-4 py-6 sm:px-6'>
            <div className='grid grid-cols-2 gap-6 lg:grid-cols-3'>
              ...
              <Card className='flex flex-col gap-6 rounded-xl border shadow-sm col-span-full w-full py-0'>
