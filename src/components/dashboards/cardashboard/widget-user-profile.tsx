    ...
    <Card className={className}>
      ...
      <CardContent className='px-6 flex flex-1 flex-col gap-6 py-6'>
        ...
        <div className='flex flex-1 flex-col gap-2'>
          ...
          <Tabs defaultValue='packed' className='flex flex-col flex-1 justify-between gap-6'>
            ...
            <TabsContent 
              value='packed' 
              className='data-[state=active]:flex flex-1 outline-none flex-col justify-evenly gap-6' 
            >
